...
# 실제로는 rao_concept_id 지만 편의를 위해 변수 이름 변경하지 않음.
rvo_concept_id <- "433195, 437540, 4334245"
...
getwd()
write.csv(check_table, "./result_cox/rao_check_table.csv")
...
getwd()
pdf("./result_cox/rao_simple_cox_km_plot.pdf", width = 25)
...
write.csv(survival_table_simple, "./result_cox/rao_simple_cox_survival_table.csv")
...
getwd()
pdf("./result_cox/rao_simple_cox_km_plot2.pdf", width = 25)
...
write.csv(survival_table_simple2, "./result_cox/rao_simple_cox_survival_table2.csv")
...
getwd()
write.csv(survival_table_timevar, "./result_cox/rao_timevar_cox_survival_table.csv")
