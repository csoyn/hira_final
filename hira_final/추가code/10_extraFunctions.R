condition_visit_cohort <- function(source_value, start_date="") {
  # 기본 sql문 토대
  # from 뒤 띄어쓰기 필수
  ...
  sql_3 <- "visit_occurrence b on (a.visit_occurrence_id=b.visit_occurrence_id) where a.CONDITION_SOURCE_CONCEPT_ID in ("
  # 인자 setting
...
procedureCohort_visit <- function(ancestor_ids, start_date="") {
  # 기본 sql문 토대
  # from 뒤 띄어쓰기 필수
